    ...
    <section className="services section" id="services">
      ...
      <div className="services__container container grid">
        <div className="services__content">
          ...
          <span className="services__button" onClick={() => setToggle(1)}>
            View More{" "}
        ...
        <div className="services__content">
          ...
          <span className="services__button" onClick={() => setToggle(2)}>
            View More
            <i className="uil uil-arrow-right services__button-icon"></i>
          </span>
          <div
        ...
        <div className="services__content">
          ...
          <span className="services__button" onClick={() => setToggle(3)}>
            View More
            <i className="uil uil-arrow-right services__button-icon"></i>
          </span>
          <div
          ...
          >
            <div className="services__modal-content">
              ...
              <h3 className="services__modal-title">Visual Desginer</h3>
              <p className="services__modal-description">
                Services with more than 3 years of experience. Providing quality
                work to clients and companies.
              </p>
